...
<section class="position-relative jarallax" data-jarallax data-speed="0.6" style="background-image: url(https://images.unsplash.com/photo-1503332628839-f788a9eedc84?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1980&q=60);">

            <div class="starbackscreen">
                <div class="text-center">
                    <h1 class="text-white font-weight-bold text-nb">Duck Developer</h1>
                    <p class="text-white text-nb">รับทำเว็บไซต์ ระบบหน้าบ้าน-หลังบ้าน</p>
                    <div class="star">
    ...
    <div class="row">
        ...
        <div class="col-md-5">
            <h4>แผนที่</h4>
            <!-- <div id="map"></div> เรียกใช้งานgoogle api จาก map -->
